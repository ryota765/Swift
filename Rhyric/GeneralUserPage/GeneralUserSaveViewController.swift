//
//  GeneralUserSaveViewController.swift
//  Rhyric
//
...
class GeneralUserSaveViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, TimelineTableViewCellDelegate {
    ...
    @IBOutlet var userSaveTableView: UITableView!
    
    override func viewDidLoad() {
        
        userSaveTableView.dataSource = self
        userSaveTableView.delegate = self
        ...
        userSaveTableView.register(nib, forCellReuseIdentifier: "Cell")
        
        
        userSaveTableView.tableFooterView = UIView()
        ...
        func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
            //auto layoutで高さ調整
            userSaveTableView.estimatedRowHeight = 161
    ...
    func loadTimeline(){
        ...
        query?.whereKey("saveUser", equalTo: userId)
        ...
        query?.findObjectsInBackground({ (result, error) in
            if error != nil{
                ...
                self.userSaveTableView.reloadData()
    ...
    func setRefreshControl() {
        ...
        userSaveTableView.addSubview(refreshControl)
    }
