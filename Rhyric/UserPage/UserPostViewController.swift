...
class UserPostViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, TimelineTableViewCellDelegate {
    ...
    func setRefreshControl() {
        ...
        userPostTableView.addSubview(refreshControl)
    }
